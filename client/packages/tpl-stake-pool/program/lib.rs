// This file is autogenerated with https://github.com/TRZLedgerFoundation/native-to-trezoaanchor
...
pub struct StakePool {
    ...
    /// Fee assessed on TRZ deposits
    pub sol_deposit_fee: Fee,

    /// Fees paid out to referrers on referred TRZ deposits.
    /// Expressed as a percentage (0 - 100) of TRZ deposit fees.
    /// i.e. `sol_deposit_fee`% of TRZ deposited is collected as deposit fees for every deposit
    /// and `sol_referral_fee`% of the collected TRZ deposit fees is paid out to the referrer
    ...
    /// Fee assessed on TRZ withdrawals
    pub sol_withdrawal_fee: Fee,

    /// Future TRZ withdrawal fee, to be set for the following epoch
...
pub enum StakePoolError {
    ...
    // 35.
    /// Too much TRZ withdrawn from the stake pool's reserve account
...
#[derive(TrezoaAnchorSerialize, TrezoaAnchorDeserialize)]
pub enum FeeType {
    /// Referral fees for TRZ deposits
    SolReferral(u8),
...
pub enum FundingType {
    ...
    StakeDeposit,
    /// Sets the TRZ deposit authority
    SolDeposit,
    /// Sets the TRZ withdraw authority
    SolWithdraw,
}
