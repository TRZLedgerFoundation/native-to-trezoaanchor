...
export const SOLEND_PROGRAM_PROGRAM_ID = new PublicKey(
...
): Program<SolendProgram> {
  return new Program<SolendProgram>(
    IDL,
    params?.programId ?? SOLEND_PROGRAM_PROGRAM_ID,
    params?.provider,
    new SolendProgramCoder(IDL)
  );
}
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "destinationDepositCollateral";
          isMut: true;
          isSigner: false;
        },
        {
