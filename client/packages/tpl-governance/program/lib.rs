...
pub struct TokenOwnerRecordV1 {
    ...
    /// The owner (either single or multisig) of the deposited governing TPL Tokens
...
pub enum GovernanceAccountType {
    ...
    /// It stores information about the particular TPL-Governance program instance
    ProgramMetadata,
...
pub enum VoteThreshold {
    ...
    // It can be implemented once Trezoa runtime supports accounts resizing to accommodate u64 size extension
