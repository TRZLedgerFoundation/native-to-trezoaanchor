...
// Change if needed
export const TPL_ATA_PROGRAM_ID = new PublicKey(
...
export const TPL_STATELESS_ASKS_PROGRAM_ID = new PublicKey(
...
export const TPL_TOKEN_2022_PROGRAM_ID = new PublicKey(
